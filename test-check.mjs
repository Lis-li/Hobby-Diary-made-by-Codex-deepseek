...
async function main() {
  ...
  const enTabToday = await ev(`document.querySelector('#tab-today').textContent`);
  const langPanelBtn = await ev(`!!document.querySelector('[data-action="toggle-panel"][data-panel="lang"]')`);
